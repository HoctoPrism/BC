...
<html lang="fr">
    ...
    <body>
        ...
        <!-- Descriptif rapide -->
        <?php require("view/inc/quickDescription.php");?>
        <!-- description complète-->
        <?php require("view/inc/fullDescription.php");?>
      <!-- Avis sur le produit -->
      <section class="container-fluid">
          <div class="row bg-secondary text-white rounded-1 p-lg-5 m-lg-5 p-md-3 m-md-3 p-1 m-0">
            ...
            <div class="col-lg-4 col-12 row">
                <!-- REVIEW ONE -->
                <?php require("view/inc/productReview.php");?>
            </div>
            <div class="col-lg-4 col-12 row">
                <!-- REVIEW TWO -->
                <?php require("view/inc/productReview.php");?>
      ...
      <section class="container-fluid text-secondary">
        ...
        <div class="row row-cols-lg-7 justify-content-lg-center flex-nowrap text-secondary perso_overflow mb-5 g-0">
            <div class="col">
              <!-- SIMILAR PRODUCT ONE -->
              <?php require("view/inc/similarProduct.php");?>
            </div>       
            <div class="col">
              <!-- SIMILAR PRODUCT TWO -->
              <?php require("view/inc/similarProduct.php");?>
